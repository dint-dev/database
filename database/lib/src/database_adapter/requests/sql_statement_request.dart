...
class SqlStatementRequest extends Request<Future<SqlStatementResult>> {
  ...
  @override
  bool operator ==(other) =>
      other is SqlStatementRequest && sqlStatement == other.sqlStatement;

  @override
  Future<SqlStatementResult> delegateTo(DatabaseAdapter adapter) {
    return adapter.performSqlStatement(this);
  }
}
