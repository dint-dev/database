...
class DatastoreTestSuite {
  ...
  final FutureOr<Datastore> Function() datastore;
  ...
  void run() {
    ...
    setUpAll(() async {
      datastore = await this.datastore();
    });
    ...
    group('Document:', () {
      ...
      group('newWriteBatch', () {
        test('upsert', () async {
          ...
          final batch = datastore.newWriteBatch();
      ...
      if (supportsTransactions) {
        group('transactions:', () {
          test('simple', () async {
            ...
            await datastore.runInTransaction(callback: (transaction) async {
              // Read
              {
