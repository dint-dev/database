...
/// }
/// ```
class CachingDatastore extends DatastoreAdapter {
  /// Master [Datastore].
  final DatastoreAdapter master;

  /// Cache [Datastore].
  final DatastoreAdapter cache;
  ...
  Stream<Resp> _mergeStreams<Req, Resp>(
      Stream<Resp> Function(DatastoreAdapter service, Req request) f,
      Req request) {
